  ...
  render() {
    return (
      <div id="wrapper" class="container-fluid">
        <h1 class="title text-center">TM Markdown Previewer</h1>
        <h2 class="subtitle">Editor</h2>
        <div id="editor-area" class="text-center">
          <textarea
          id="editor"
        ...
        <div id="preview-area" class="w-75 d-flex justify-content-center mx-auto">
          <div id="preview" dangerouslySetInnerHTML={{ __html: this.state.parsed }}></div>
        </div>
      </div>
    );
  }
